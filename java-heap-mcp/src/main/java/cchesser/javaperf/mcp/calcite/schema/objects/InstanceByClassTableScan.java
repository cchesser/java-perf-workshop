 ...
 * Original class: {@code com.github.vlsi.mat.calcite.schema.objects.InstanceByClassTableScan}.
 */
public class InstanceByClassTableScan extends TableScan {
  private final InstanceByClassTable instanceByClassTable;

  public InstanceByClassTableScan(RelOptCluster cluster, RelOptTable relOptTable,
      InstanceByClassTable instanceByClassTable) {
