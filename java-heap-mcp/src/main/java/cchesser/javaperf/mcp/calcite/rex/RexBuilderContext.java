package cchesser.javaperf.mcp.calcite.rex;

import cchesser.javaperf.mcp.calcite.functions.ISnapshotMethods;
import cchesser.javaperf.mcp.calcite.schema.objects.HeapOperatorTable;
 ...
 * Original class: {@code com.github.vlsi.mat.calcite.rex.RexBuilderContext}.
 */
public abstract class RexBuilderContext {
  private final RelOptCluster cluster;
  private RexNode object;

  private static final SqlFunction GET_IOBJECT =
  ...
  public RexNode getIObject() {
    if (object == null) {
      object = getBuilder().makeCall(GET_IOBJECT, getSnapshot(), getIObjectId());
    }
    return object;
  }
}
