...
import static cchesser.javaperf.mcp.calcite.schema.objects.SnapshotRexExpressions.getClassLoader;
import static cchesser.javaperf.mcp.calcite.schema.objects.SnapshotRexExpressions.getClassName;
import static cchesser.javaperf.mcp.calcite.schema.objects.SnapshotRexExpressions.getClassOf;
import static cchesser.javaperf.mcp.calcite.schema.objects.SnapshotRexExpressions.getSuper;
import static cchesser.javaperf.mcp.calcite.schema.objects.SnapshotRexExpressions.resolveField;

/**
 * Sourced from <a href="https://github.com/vlsi/mat-calcite-plugin">MAT Calcite Plugin</a>.
 * Original class: {@code com.github.vlsi.mat.calcite.schema.objects.ClassRowTypeCache}.
 */
public class ClassRowTypeCache {
  ...
  private static final class ClassRowTypeResolver
    ...
    public Pair<RelDataType, List<Function<RexBuilderContext, RexNode>>> load(
      ...
      RelDataType anyNull = typeFactory.createTypeWithNullability(any, true);
      types.add(any);
      ...
      for (Field field : fieldsInOrder) {
        ...
        case ExtraTypes.CHARACTER:
          dataType = typeFactory.createTypeWithNullability(
