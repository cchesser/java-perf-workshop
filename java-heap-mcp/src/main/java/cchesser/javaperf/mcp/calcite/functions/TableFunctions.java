...
import cchesser.javaperf.mcp.calcite.collections.CollectionsActions;
import cchesser.javaperf.mcp.calcite.schema.references.OutboundReferencesTable;
 ...
 * Original class: {@code com.github.vlsi.mat.calcite.functions.TableFunctions}.
 */
    ...
    if (!(r instanceof HeapReference)) {
      ...
      try {
        ...
        if (collectionExtractor == null) {
          ...
          references = collectReferences(ref.getIObject().getSnapshot(),
              collectionExtractor.extractEntryIds(ref.getIObject()));
        }
